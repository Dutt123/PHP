...
/**
 * This code is directly from AgGrid Server Side Pagination Repo. We have disabled all Group By features as it was giving errors.
 * Source : https://github.com/ag-grid/ag-grid-server-side-nodejs-example/blob/master/server/olympicWinnersService.js
 *
 * @TODO : Integrate this with sequelize
 */
...
class EntriesPaginateService {
  ...
  buildSql(request) {
    ...
    const SQL = selectSql + fromSql + whereSql + orderBySql + limitSql;
...
export default new EntriesPaginateService();
